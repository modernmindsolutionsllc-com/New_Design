...
import { Globe, Smartphone, Megaphone, Palette, Workflow, Bot, CheckCircle2 } from 'lucide-react'
...
@media (max-width: 640px) { .services-preview__grid { grid-template-columns: 1fr; } .services-preview__header { flex-direction: column; } }
`
