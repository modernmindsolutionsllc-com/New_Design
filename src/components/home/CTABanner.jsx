      ...
      <div className="container">
        ...
        >
          ...
          <motion.p className="cta-banner__subline" variants={FADE_UP}>
            Fill our 3-minute questionnaire and we'll get back to you within 24 hours.
            No commitment, no tech jargon.
          </motion.p>
...
.cta-banner__tag { color: var(--color-gold); }
.cta-banner__heading {
...
.cta-banner__primary {
  ...
  border-color: var(--color-gold); border: 2px solid var(--color-gold);
  padding: 0.875rem 2rem; border-radius: var(--radius-full);
  font-weight: 700; text-decoration: none; transition: var(--transition-base);
}
...
.cta-banner__secondary {
  ...
  padding: 0.875rem 2rem; border-radius: var(--radius-full);
  font-weight: 600; text-decoration: none; transition: var(--transition-base);
}
